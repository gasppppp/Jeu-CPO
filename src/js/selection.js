...
/***********************************************************************/
  ...
  preload() {
    ...
    this.load.spritesheet('img_portail', 'src/assets/assets_bienvenue/spritesheet_portail.png', {
      frameWidth: 32,
      frameHeight: 32
    });
  ...
  create() {
    ...
    this.anims.create({
      key: "anim_portail",
      frames: this.anims.generateFrameNumbers("img_portail", {
        start: 0,
        end: 7
      }),
      frameRate: 10,
